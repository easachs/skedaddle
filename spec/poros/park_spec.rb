...
RSpec.describe ParkPoro do
  before do
    ...
    @park = described_class.new(@attributes)
  end
  ...
  it 'errors gracefully' do
    bad_park = described_class.new({})
    expect(bad_park.name).to be_nil
    expect(bad_park.city).to be_nil
    expect(bad_park.state).to be_nil
    expect(bad_park.country).to be_nil
